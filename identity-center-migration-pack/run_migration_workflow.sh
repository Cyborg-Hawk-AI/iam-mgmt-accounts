...
usage() {
  ...
  echo "    → Discovers SSO roles only, writes human-readable report under {account_id}/data/processed/"
  echo "    → Creates {account_id}-iam-discovery.tar.gz. Download it. Show your boss: data/processed/SSO_ROLES_AND_POLICIES.md"
  echo ""
